  ...
  return (
    <div>
        <div className='container'>
            ...
            <p>Los productos tardan entre 2 a 3 días hábiles en llegar al domicilio</p>
            <hr/>
            <h2 style={{fontSize:30}}>¿Cuál es el valor del envío?</h2>
            <p>Depende de la direccion de entrega, pero dado el tamaño de los productos se mueven entre $ 2.000 a $ 3.500</p>
            <hr/>
            <h2 style={{fontSize:30}}>¿Donde se realizan las entregas presenciales?</h2>
            <p>Estas entregas se acuerdan con cada cliente, y las zonas de entrega las puede encontrar en nuestra sección "Ubícanos"</p>
            <hr/>
            <h2 style={{fontSize:30}}>¿Ofrecen cambios o reembolos?</h2>
            <p>Si, ofrecemos cambios, devoluciones o reembolosos si el producto no era de su talla o si se vio dañado en transporte</p>
            <hr/>
            <h2 style={{fontSize:30}}>¿Cuánto tiempo tengo para realizar una devolución?</h2>
            <p>30 días hábiles, tal como cualquier tienda comercial</p>
            <hr/>
